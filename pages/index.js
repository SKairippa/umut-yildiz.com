			...
			<Main>
				<Left visibility={visible}>
					<section>
						...
						<p className="bio">
							I am a Web Developer, I live in Turkey/Antalya, I am 19 years old, I am a Manager at Satan Hosting, I develop Satan Hosting as well as develop my personal site. I help people a lot about Web Software.{" "}
						...
						<div className="profile">
							...
							<a href="mailto:hello@umut-yildiz.com">hello@umut-yildiz.com</a>
						</div>
						<div className="details">
							<Link href="https://github.com/umutyildiz2022" target="_blank">
								<FaGithub size={18} />
								<span>GitHub</span>
								<HiOutlineExternalLink size={16} />
							</Link>
							<Link
								href="https://www.linkedin.com/in/umutyildiz2022/"
								target="_blank"
							>
								<FaLinkedin size={18} />
								<span>Linkedin</span>
						...
						<div className="details">
							<Link href="https://twitter.com/umutyildiz2022" target="_blank">
								<FaTwitter size={18} />
								<span>Twitter</span>
								<HiOutlineExternalLink size={16} />
							</Link>
							<Link
								href="https://www.youtube.com/channel/UmutYildiz2022?view_as=subscriber"
								target="_blank"
							>
								<FaYoutube size={18} />
								<span>YouTube</span>
